...
#
# create_vivado_proj.tcl: Tcl script for re-creating project 'reset'
#
...
set files [list \
 [file normalize "${origin_dir}/../reset.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../reset.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "reset" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../reset_tb.vhd"] \
]
add_files -norecurse -fileset $obj $files
...
set file "$origin_dir/../reset_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "library" -value "reset_lib" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "reset_tb" -objects $obj
set_property -name "top_lib" -value "reset_lib" -objects $obj
